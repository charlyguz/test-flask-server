...
def test_function():
    ...
    try:
        ...
        print("API Key válida. Modelos disponibles:"+str(response))
...
def start_interaction(file_path):
    try:
        ...
        user_input = transcribe_speech_to_text_with_whisper(file_path)
        ...
        user_confirmation = transcribe_speech_to_text_with_whisper()
